...
//-------------------------------------------//Array functions
const add = (n1: number, n2: number = 55) => n1 + n2;  // assign a default value for the "last parameter" and call func with one argument
// console.log(add(2, 5));
const printOut: (a: string | number) => void = res => console.log(res);
printOut(add(2));
...
const person3 = { ...person} //It creates a real copy of the original obj = a new object
console.log(person2, person3);

//-------------------------------------------//Rest Operator: 
const addition = (...items: number[]) => {
